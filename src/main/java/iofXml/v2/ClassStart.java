...
public class ClassStart {
     ...
     * This is why there is not a <CODE>set</CODE> method for the personStartOrTeamStart property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the personStartOrTeamStart property.
     */
    public List<Object> getPersonStartOrTeamStart() {
        if (personStartOrTeamStart == null) {
            personStartOrTeamStart = new ArrayList<>();
        }
